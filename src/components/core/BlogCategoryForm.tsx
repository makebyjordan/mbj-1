...
import { createBlogCategory, updateBlogCategory, BlogCategory } from "@/services/blog-categories";
...
export default function BlogCategoryForm({ category, onSave }: BlogCategoryFormProps) {
    ...
    <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    <Input placeholder="Tutoriales de Next.js" {...field} className="bg-background/50" />
                </FormControl>
                <FormMessage />
                </FormItem>
            )}
