...
export default function ToolForm({
  ...
  const handleCreateCategory = async (inputValue: string) => {
    ...
    try {
      ...
      onCategoryCreated(); // Refresca categorías en el dashboard
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        {/* Envolver react-select con FormControl para cumplir el contrato de shadcn */}
        <FormField
          control={form.control}
          name="categoryIds"
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <CreatableSelect
                  ...
                  name={field.name}
                  onBlur={field.onBlur}
                  // ref={field.ref} // Descomenta solo si lo necesitas y no da warning
                />
              </FormControl>
              <FormMessage />
            </FormItem>
        ...
        {/* Checkbox: un único hijo dentro de FormControl */}
        <FormField
          control={form.control}
          name="isPaid"
          render={({ field }) => (
