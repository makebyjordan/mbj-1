...
export default function N8NLoginPage() {
        ...
        <div className="z-10 w-full max-w-md">
            <Card className="glass-card">
                <CardHeader className="text-center">
                    ...
                    <CardTitle className="font-headline text-4xl">Plantillas N8N</CardTitle>
                    <CardDescription>Introduce el código de acceso para ver las plantillas.</CardDescription>
                </CardHeader>
                <CardContent>
