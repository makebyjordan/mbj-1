...
// GET /api/formations - Obtener todos
export async function GET() {
  try {
    ...
    return errorResponse('Error al obtener formations', 500)
  }
}

// POST /api/formations - Crear nuevo
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse(error.message || 'Error al crear formation', 500)
  }
}
